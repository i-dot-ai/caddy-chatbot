...
def test_enrolment_domain_false():
    ...
    assert response == {'text': 'Your domain is not enrolled in Caddy. Please contact your administrator.'}
...
def test_enrolment_user_false():
    ...
    assert response == {'text': 'User is not registered, please contact your administrator for support in onboarding to Caddy'}
