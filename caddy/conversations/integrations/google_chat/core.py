...
class GoogleChat():
    ...
    def send_message_to_adviser_space(self, space_id, thread_id, message):
        ...
        """
        response = self.caddy.spaces().messages().create(
    ...
    @xray_recorder.capture()
    def send_pii_warning_to_adviser_space(self, space_id: str, thread_id: str, message, message_event):
    ...
    def handle_survey_response(self, event):
        ...
        self.update_survey_card_in_adviser_space(space_id=spaceId, message_id=messageId, card={'cardsV2': card})
